...
from Page_Object.Android.SmartExercisePage import SmartExam
...
@allure.feature('APP智能练习功能')
class SmartExarciseTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        Log = Logger()
    ...
    def setUp(self):
        Home(self.driver).shot_menu("智能练习")
        SmartExam(self.driver).start_answer()
    def tearDown(self):
        pass
    @allure.story("收藏试题测试")
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(SmartExarciseTest)
